...
class TestRecordActivityAction(unittest.TestCase):
    ...
    def test002_recordActivityAction_Activity1_UpdatesBalance(self):
        ...
        self.assertGreaterEqual(len(options), 3,
            'Unable to find at least 3 options to choose from. Check your formatActivityMenu function')
    ...
    def test005_recordActivityAction_RandomActivityChoice_UpdatesBalance(self):
        from main import formatActivityMenu
    ...
    def test006_recordActivityAction_AllOptions_UpdatesBalance(self):
        from main import formatActivityMenu
    ...
    def test007_recordActivityAction_badOption(self):
        from main import recordActivityAction
        from main import formatActivityMenu
        from caloric_balance import CaloricBalance
